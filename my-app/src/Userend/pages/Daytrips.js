...
import daytrips1 from "../images/daytrips1.jpeg";
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-xl-4 col-md-6 px-0  ">
            ...
            <img src={daytrips1} class="img-fluid" id="day1"></img>
          ...
          <div class="col-xl-4 col-md-6 ">
            ...
            <div class="row  flex-column">
              ...
              <div class="col-12 p-0 border border-dark ">
                {" "}
                <img src={daytrips2} class="img-fluid" id="daytrip2"></img>
              ...
              <div class="col-12">
                ...
                <div class="row">
                  ...
                  <div class="col-6 px-0 py-0">
                    <img src={daytrips3} class="img-fluid" id="daytrips3"></img>
                  </div>

                  <div class="col-6 px-0  py-0">
                    <img src={daytrips4} class="img-fluid" id="daytrips4"></img>
                  </div>
          ...
          <div class="col-xl-4 col-md-6 border border-dark ">
          
            <div class="row border border-dark justify-content-between">
        ...
        <div class="row">
            ...
            <div class="row"><div class="col-12 text-start mt-3"><h5>DURATION</h5></div>
            <div class="row">
            <select class="form-select">
            ...
            <option value="5hours">FIVE fives</option>
             ...
             <div class="row mt-3">
                 <div class="col-6 border border-dark "><h5>START DATE</h5></div>
             <div class="col-6 border border-dark"><h5>END DATE</h5></div>
...
<div className="col-12 px-0 border border-dark">
<button class=" btn bg-primary" id="button">
                <h5>Book Now</h5>
              </button>
</div>
</div>
...
{/* check mistake in this line */}

      <div class="container border border-dark mt-3">  
      <div class="row">
        <div class="col-md-4 col-sm-6 col-12  px-0 border border-dark">
          <h5>INTERIOR</h5>
        </div>
        <div class="col-md-4 col-sm-6 col-12  px-0 border border-dark">
          <h5>EXTERIOR</h5>
